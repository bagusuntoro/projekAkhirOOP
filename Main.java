...
public class Main extends Login{
  ...
  public static void updateData() throws IOException {
    ...
    while (data != null) {
      ...
      if (noUpdate == index) {
        ...
        // String originalData = st2.nextToken();
        // System.out.println("tesss"+st2.nextToken());

        for (int i = 0; i < fieldData.length; i++) {
          boolean isUpdate = getYesOrNo("apakah anda ingin merubah " + fieldData[i]);
          // originalData = st2.nextToken();
        ...
        if (isUpdate) {
          ...
          if (isExist) {
            ...
            String nrp = tempData[0];
            String nama = tempData[1];
            String umur = tempData[2];
            String alamat = tempData[3];

            // tulis data ke database
            bufferedOutput.write(nrp + "," + nama + "," + umur + "," + alamat);
          }
  ...
  public static boolean cekDataDiDatabase(String[] keywords, boolean isDisplay) throws IOException {
